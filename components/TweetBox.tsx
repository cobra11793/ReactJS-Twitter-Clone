    ...
    <div className='flex space-x-2 p-5'>
      ...
      <div className='flex flex-1 items-center pl-2'>
        <form className='flex flex-1 flex-col'>
            <input className= 'h-24 w-full text-xl outline-none placeholder:text-xl' type='text'placeholder="What's Happening?" onChange={(e) => setInput(e.target.value)} value={input} />
